module github.com/gh-efforts/LtoY

go 1.22.3

require (
	github.com/filecoin-project/boost/extern/boostd-data v0.0.0-20240626173351-5dcdc1cdd1ef
...
require (
	...
	github.com/filecoin-project/boost v1.4.0 // indirect
